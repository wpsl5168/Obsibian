...
> 快照时间：2026-04-23 · 数据源：OpenHippo hook召回

- **[2026-04-22 05:15] [assistant]** 河南烩面，羊肉汤底配宽面，绝配。看到hook召回正常工作了——历史"我喜欢用Python"和当前面食偏好都召回了。再来一句：你最近常去的烩面馆是哪家？北京的话萧记还是合记你更认？
- **[2026-04-22 21:47] [user]** 评价下整体质量
- **[2026-04-22 21:27] [user]** 不用，只是了解一下
- **[2026-04-23 00:09] [user]** OK，测试下通道
- **[2026-04-22 22:42] [user]** 把那个数据源先分析下，出个报表看看
...
- [[30-调研报告/教育/教育路线图.md|🎯 老王娃教育路线图（4 岁→3 年级）]] — 执行 checklist，按阶段+预算+红线，**家庭执行入口**  🔴
...
## 🏦 调研：银行业 AI 转型（对公客户管理系统视角）

- [[40-调研报告/银行业AI转型/README.md|🏦 银行业 AI 转型调研 · 索引]] — 6 篇系列 + 核心结论速查（包壳 vs 重写、POC 选型、五件套授权）  🔴
- [[40-调研报告/银行业AI转型/00-行业全景与大行案例对标.md|① 12 家上市银行 AI 案例对标（2025）]] — 投入/场景/标杆产品/量化效果  🟡
- [[40-调研报告/银行业AI转型/01-企业级AI架构六层蓝图.md|② 企业级 AI 架构六层蓝图]] — 基座→模型→知识→工具→Agent→入口  🟡
- [[40-调研报告/银行业AI转型/02-老系统改造路径-CLI化与MCP包壳.md|③ 老系统改造路径 — CLI 化与 MCP 包壳]] — 6 类资产分别怎么 AI 化  🟡
- [[40-调研报告/银行业AI转型/03-数据授权与权限控制四维矩阵.md|④ 数据授权四维矩阵 + 五条防线]] — RBAC+ABAC+RLS+脱敏+审计，含 SQL  🟡
- [[40-调研报告/银行业AI转型/04-角色赋能-RM副驾驶到行领导驾驶舱.md|⑤ 角色赋能 — 五层用户的 AI 工具地图]] — RM/支行长/部门总/分行领导/行长  🟡
- [[40-调研报告/银行业AI转型/05-12-18个月落地路径与POC选型.md|⑥ 12-18 个月落地路径与 POC 选型]] — 六阶段、成本测算、踩坑清单  🟡
- [[40-调研报告/银行业AI转型/06-国有大行企业级大模型落地专题.md|⑦ 国有大行企业级大模型专题]] — 六大行+招行平台对标·进展·场景·7 大趋势·监管红线  🔴
...
### 10-知识库/AI模型与Agent/02-提示词工程与输出规范
- [[2.2.1-推理模型工程化进阶|推理模型工程化进阶 — LRMs训练 / Inference Scaling / 部署]]
- [[2.3.1-结构化输出-厂商能力对比|结构化输出 — 各大模型厂商能力对比]]
- [[2.3.2-结构化输出-工程实战|结构化输出 — 工程实战]]

### 10-知识库/AI模型与Agent/03-工具调用与上下文协议
- [[3.2.1-MCP-Server生态系统|MCP Server 生态系统]]
- [[3.2.2-MCP-SDK开发实战|MCP SDK 与开发实战]]
- [[3.2.3-MCP协议架构与传输层|MCP 协议架构与传输层]]

### 10-知识库/AI模型与Agent/04-智能体架构与工作流设计
- [[4.1.1-Agent认知架构与主流框架2026|Agent 2026 认知新进展 + 主流框架横评]]
- [[4.2.1-LangGraph深度实操|LangGraph 深度实操]]
- [[4.2.2-工作流工程最佳实践|工作流工程最佳实践]]

### 10-知识库/AI模型与Agent/06-工程落地与Vibe_Coding实战
- [[6.3.1-SWE-Agent生产化与CICD|SWE-Agent 生产化与 CI/CD 闭环]]

### 10-知识库/DeepLearning.AI学习路径
- [[DeepLearning.AI-按主题索引|DL.AI 按主题快速索引]]
- [[DeepLearning.AI-全量目录|DL.AI 全量课程目录]]

### 20-项目/海马体/PRD分卷
- [[prd-07-附录A-API接口汇总|PRD 附录 A：API 接口汇总]]
- [[prd-07-附录B-数据库Schema|PRD 附录 B：数据库 Schema]]
- [[prd-07-附录C-Hermes集成架构决策|PRD 附录 C：Hermes 集成架构决策]]
