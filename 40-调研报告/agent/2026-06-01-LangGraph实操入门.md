...
> 配套概念页：[[40-调研报告/agent/2026-06-00-Agent编排入门-由浅入深|Agent 编排入门（由浅入深）]]。
...
## 关联阅读
- [[40-调研报告/agent/2026-06-00-Agent编排入门-由浅入深|Agent 编排入门（由浅入深）]] — 先读这篇懂概念
- [[40-调研报告/agent/2026-06-Agent编排框架横评-SK-MAF-LangChain|Agent 编排框架横评]] — 横向对比 8 个框架
- [[10-知识库/AI模型与Agent/04-智能体架构与工作流设计/4.2.1-LangGraph深度实操|LangGraph 深度实操]] — 库内已有的进阶笔记
