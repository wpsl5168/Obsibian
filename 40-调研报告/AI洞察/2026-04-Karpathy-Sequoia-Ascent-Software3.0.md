...
### ⑥ 创业者机会
- 找**有价值 + 可验证 + labs 还没重点训练**的领域。能造领域专属 RL 环境→自己 fine-tune 也能提升。数学/代码已被 labs 占满，但很多经济重要领域有未开发的潜在可验证结构。**这就是 startup wedge。**（详见 [[2026-盈利线索-可验证RL环境wedge]]）
...
- [[2026-盈利线索-可验证RL环境wedge]] — 本文 ⑥ 衍生的可执行盈利线索
- [[../../20-项目/AI风口调研/2026-AI风口-张雪峰视角]] — 另一视角的风口调研
