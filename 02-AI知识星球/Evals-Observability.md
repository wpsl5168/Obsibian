...
- 2026-02：Microsoft [[AI Agent]] Framework RC 强调工作流+可观测等生产化能力。
  - <https://devblogs.microsoft.com/foundry/microsoft-agent-framework-reaches-release-candidate/>

## 一手/权威入口
- Microsoft [[AI Agent]] Framework（官方博客/RC）：<https://devblogs.microsoft.com/foundry/microsoft-agent-framework-reaches-release-candidate/>
