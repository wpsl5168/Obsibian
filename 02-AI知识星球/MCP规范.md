...
[[AI-Agent架构]] 中提到，工具调用是 Agent 与外部世界交互的桥梁。**MCP** (Model Context Protocol) 提供了一套标准化的工具定义和调用协议。
...
## 与其他系统的联动
掌握了 MCP，我们就能将各种企业内部系统无缝接入 [[Workflow设计模式]]，并在 [[SWE-Agent实战]] 中赋予代码生成工具更强大的能力。