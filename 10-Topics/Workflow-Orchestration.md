...
- 2023→：Agent 从 prompt 驱动转向显式 workflow/graph（分支/循环/重试/checkpoint/HITL）。
...
- 2026-02：Microsoft Agent Framework RC：提供 graph-based workflows + streaming + checkpointing + HITL。
...
- Microsoft Agent Framework：<https://devblogs.microsoft.com/foundry/microsoft-agent-framework-reaches-release-candidate/>
