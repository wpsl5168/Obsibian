...
- 新增 [[40-调研报告/2026-09-08-十只持仓综合研究]]：核四股2026半年报、六ETF中报股票表、历史量价和条件化建议，status=draft保留待确认的风险预算与买入逻辑。
...
- 新增 [[40-调研报告/2026-09-08-股票交易接入技术方案]]，比较券商条件单、认可API和RPA；推荐研究草案与人审、风控、执行分权。
...
- 新增 [[40-调研报告/2026-09-08-全账户条件单与仓位整理草案]]，按用户纠正的“截图只是功能展示、需要整体方案”覆盖全部10只持仓。
...
- 新增 [[40-调研报告/2026-09-22-赣东北五日亲子行程]] 及单文件HTML：地图、五日卡片、每日住宿餐饮、雨天/疲劳替代、儿童票、租还车与返程缓冲。
